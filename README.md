...
* View public key
* Generate license (a signed string) from the given JSON message string. Signing uses the private key.
* Verify the license by providing the JSON message and the signed string. If the message is altered, then the verification will fail. Verification uses the public key.
